...
Source: https://aps.autodesk.com/en/docs/viewer/v7/reference/Viewing/Viewer3D/
...
## [new Viewer3D(container, config)](#new-viewer3d-container-config)
...
| theme   string | Set this to ‘light-theme’ if you want to use the light ui theme. Themes can be changed during execution by calling setTheme() and passing the theme’s name. |
