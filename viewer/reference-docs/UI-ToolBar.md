...
Source: https://aps.autodesk.com/en/docs/viewer/v7/reference/UI/ToolBar/
...
# ToolBar
> Extends [`Autodesk.Viewing.UI.ControlGroup`_](#id36)

## [new ToolBar(id, options)](#new-toolbar-id-options)
...
| alignVertically   boolean | Whether this toolbar should be vertically positioned on the right side. |
