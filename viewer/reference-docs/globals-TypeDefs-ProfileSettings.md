...
| settings   [Settings](/en/docs/viewer/v7/reference/globals/TypeDefs/Settings/) | Used by the Profile to apply to the viewer preferences. |
...
| extensions   [Extensions](/en/docs/viewer/v7/reference/globals/TypeDefs/Extensions/) | Extensions that should or should not be loaded. |
