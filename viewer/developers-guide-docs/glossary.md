...
| document | The file for the model you want to load. The doc gives access to the root and provides a method for finding elements by id. To learn more, see [Document](/en/docs/viewer/v7/reference/Viewing/Document). |
...
| manifest | The result of a translation process, a structured collection of resources (e.g., model geometry, thumbnails, camera views) used by Viewer SDK.       Get a manifest using the [GET :urn/manifest](/en/docs/model-derivative/v2/reference/http/urn-manifest-GET/) endpoint.       Viewer SDK can only render viewables. |
...
| overlay | A feature that allows you to add custom geometry to the loaded model. To learn more, see the [Add Custom Geometry](/en/docs/viewer/v7/developers_guide/advanced_options/custom-geometry/) tutorial. |
