...
Method and URI DELETE https://developer.api.autodesk.com/oss/v2/buckets/:bucketKey Authentication Context app-only Required OAuth Scopes bucket:delete
...
```
curl -v "https://developer.api.autodesk.com/oss/v2/buckets/bucketexamplekey" -X DELETE
