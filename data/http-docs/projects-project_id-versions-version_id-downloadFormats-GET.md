...
Method and URI GET https://developer.api.autodesk.com/data/v1/projects/:project_id/versions/:version_id/downloadFormats Authentication Context user context optional Required OAuth Scopes data:read Data Format JSON
...
200 OK Successful retrieval of the available download formats for a specific version. 400 Bad Request The request could not be understood by the server due to malformed syntax or missing request headers.
...
```
curl -v 'https://developer.api.autodesk.com/data/v1/projects/:project_id/versions/:version_id/downloadFormats' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```

### Response

```
{ "jsonapi" : { "version" : "1.0" }, "links" : { "self" : { "href" : "/data/v1/projects/{some_project_id}/versions/{some_version_id}/downloadFormats" } }, "data" : { "type" : "downloadFormats" , "id" : "96af4f60-53b8-4efe-b890-1eaa9ea5cb08" , "attributes" : { "formats" : [ { "fileType" : "pdf" }, { "fileType" : "dwg" } ] } } }
```
