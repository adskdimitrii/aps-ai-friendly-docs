...
| data   object | The properties of item. The property should conform to schema requirements; otherwise, it will be ignored. |
...
| 201   Created | Successful creation of a version of a file, or the file was successfully copied. |
| --- | --- |
...
| 409   Conflict | The specified resource already exists, has been modified, or is in the middle of being uploaded, updated, or copied. |
