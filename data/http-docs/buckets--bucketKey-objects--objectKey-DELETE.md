...
Method and URI DELETE https://developer.api.autodesk.com/oss/v2/buckets/:bucketKey/objects/:objectKey Authentication Context app-only Required OAuth Scopes data:write
...
bucketKey * string URL-encoded bucket where object was uploaded into. objectKey * string URL-encoded object  key to to be deleted.
...
```
curl -v "https://developer.api.autodesk.com/oss/v2/buckets/bucketexamplekey/objects/objectKey" -X DELETE
-H "Authorization: Bearer kuhodzPEHSCrWH3Pm1WuBMBnxw39" -H "Content-Type: application/json;charset=UTF-8"
```
