...
| public-resource-fallback   boolean | Allows fallback to [OSS signed URLs](/en/docs/data/v2/reference/http/buckets-:bucketKey-objects-:objectKey-signed-POST) in case of unmerged resumable uploads. |
