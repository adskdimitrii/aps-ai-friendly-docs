...
Source: https://aps.autodesk.com/en/docs/data/v2/reference/http/projects-project_id-items-item_id-GET/
...
- To retrieve metadata for multiple items, see the [ListItems](/en/docs/data/v2/overview/commands) command.
