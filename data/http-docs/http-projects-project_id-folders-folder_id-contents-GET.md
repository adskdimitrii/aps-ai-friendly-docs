...
Source: https://aps.autodesk.com/en/docs/data/v2/reference/http/projects-project_id-folders-folder_id-contents-GET/
...
| filter[lastModifiedTimeRollup]   array: string | Filter by the `lastModifiedTimeRollup` in `attributes`<br>Supported values are date-time string in the form `YYYY-MM-DDTHH:MM:SS.000000Z` or `YYYY-MM-DDTHH:MM:SS` based on [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) |
...
| includeHidden   boolean | `true`: response will also include items and folders that were deleted from BIM 360 Docs projects. <br>`false` (default): response will not include items and folders that were deleted from BIM 360 Docs projects.<br>To return only items and folders that were deleted from BIM 360 Docs projects, see the [Filtering](https://aps.autodesk.com/en/docs/data/v2/overview/filtering/) section. |

### Response

## [HTTP Status Code Summary](#http-status-code-summary)

| 200   OK | Successful retrieval of the folder contents collection associated with a specific folder. |
| --- | --- |
