...
ROOT_URL = "https://aps.autodesk.com/en/docs/ssa/v1/tutorials/"
CUSTOM_JS_URL = "https://aps.autodesk.com/params/custom.js"
CONFIG_FILENAME = "ssa_v1.json"
OUTPUT_DIR = Path(__file__).resolve().parent / "tutorials-docs"
TIMEOUT = 30
...
def collect_tutorial_leaf_nodes(config: dict) -> list[dict]:
    ...
    while queue:
        ...
        if full_path.startswith("ssa/tutorials/") and source:
            leaves.append(
                {
                    "full_path": full_path,
                    "url_path": url_path,
