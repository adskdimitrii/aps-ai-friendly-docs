...
ROOT_URL = "https://aps.autodesk.com/en/docs/ssa/v1/developers_guide/"
CUSTOM_JS_URL = "https://aps.autodesk.com/params/custom.js"
CONFIG_FILENAME = "ssa_v1.json"
...
def collect_guide_leaf_nodes(config: dict) -> list[dict]:
    ...
    while queue:
        ...
        if full_path.startswith("ssa/developers_guide/") and source:
            leaves.append(
                {
                    "full_path": full_path,
                    "url_path": url_path,
