...
- See the Authentication and Scopes section on the Data Management API’s [API Basics](https://aps.autodesk.com/en/docs/data/v2/overview/basics/) page for the appropriate token based on the data that you’re accessing.
...
A project’s ID is used as the project level scope. Retrieve the project/container ID for your project as described in the [Retrieve project id](../../acc/how-to-docs/cost-retrieve-cost-container-id.md) walkthrough.
