...
Source: https://aps.autodesk.com/en/docs/model-derivative/v2/reference/http/urn-metadata-guid-GET/
...
| --- | --- |
| modelGuid   string | The ID of the Model View you are extracting the object tree from. Use the [List Model Views](https://aps.autodesk.com/en/docs/model-derivative/v2/reference/http/metadata/urn-metadata-GET/) operation to obtain the IDs of the Model Views in the source design. |
...
| level   string | Specifies how many child levels of the hierarchy to return, when the `objectid` parameter is specified. Currently supports only `level` = `1`. |

### Response

## [HTTP Status Code Summary](#http-status-code-summary)

| 200   OK | The object tree of the specified Model View was successfully retrieved. |
| --- | --- |
