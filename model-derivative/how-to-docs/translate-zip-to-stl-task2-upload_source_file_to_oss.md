...
Source: https://aps.autodesk.com/en/docs/model-derivative/v2/tutorials/translate-zip-to-stl/task2-upload_source_file_to_oss/
...
While you can use any zip file containing a model, for the purpose of learning we recommend that you use the file *Tuner.zip* we provide. You can download this file from the *walkthrough_data* folder of the GitHub repository containing the Postman Collection for this walkthrough.
...
- Replace <YOUR_OBJECT_KEY> with *Tuner.zip*, which is the name of the file we recommend that you upload.
...
1. Download the file *Tuner.zip* from <https://github.com/autodesk-platform-services/aps-tutorial-postman/tree/master/ModelDerivative_02/walkthrough_data>.
...
## [Step 5 - Convert the Source File URN to a Base64-encoded URN](#step-5-convert-the-source-file-urn-to-a-base64-encoded-urn)
