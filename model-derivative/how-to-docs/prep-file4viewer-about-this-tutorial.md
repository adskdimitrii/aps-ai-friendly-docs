...
Source: https://aps.autodesk.com/en/docs/model-derivative/v2/tutorials/prep-file4viewer/about-this-tutorial/
...
To display a model in the Viewer, you must first translate the model to the SVF2 format. This walkthrough guides you through the process of translating an Inventor model (*iam* file and referenced *.ipt*) to the SVF2 format, and displays the model in a browser, using the Viewer SDK.
