...
| 15 | created_at | timestamp: SQL |  | Created at timestamp |
| 16 | created_by | string |  | Autodesk User ID of the user who created the attachment. |
| 17 | deleted_at | timestamp: SQL |  | Deleted at timestamp |
| 18 | deleted_by | string |  | Autodesk User ID of the user who deleted the attachment. |
| 19 | updated_at | timestamp: SQL |  | Date and time the attachment was updated in ISO8601 format |
...
Placements associated with ACC issues. - This is the Change Data Capture (CDC) enabled version of the issues.placements table.

| ordinal_position | column_name | data_type | constraints | notes |
| --- | --- | --- | --- | --- |
| 1 | placement_id | string: UUID |  | Unique identifier of the placement |
| 2 | bim360_account_id | string: UUID |  | Added for account scoping of issues data |
| 3 | bim360_project_id | string: UUID |  | Added for project scoping of issues data |
| 4 | issue_id | string: UUID |  | BIM 360 ID of the issue associated with the placement. Foreign Key: Table: issues Column: id |
| 5 | lineage_urn | string |  | Lineage URN of the model element |
| 6 | type | string |  | Type of the placement |
...
| 11 | created_at | timestamp: SQL |  | Date and time the placement was created in ISO8601 format |
| 12 | updated_by | string |  | Autodesk User ID of the user who updated the placement |
| 13 | updated_at | timestamp: SQL |  | Date and time the placement was updated in ISO8601 format |
...
Viewables associated with placements of ACC issues. - This is the Change Data Capture (CDC) enabled version of the issues.viewables table.
...
| 2 | bim360_account_id | string: UUID |  | Added for account scoping of issues data |
| 3 | bim360_project_id | string: UUID |  | Added for project scoping of issues data |
| 4 | issue_id | string: UUID |  | BIM 360 ID of the issue associated with the viewable (through placement) Foreign Key: Table: issues Column: id |
| 5 | file_version | number |  | Version of the file containing the viewable |
| 6 | file_version_urn | string |  | URN of the file version |
| 7 | guid | string |  | Global unique identifier of the viewable |
| 8 | name | string |  | Name of the viewable |
| 9 | viewable_id | string |  | Identifier of the viewable |
| 10 | is_3d | boolean |  | Indicates whether the viewable is 3D (true) or 2D (false) |
| 11 | created_at | timestamp: SQL |  | Date and time the viewable was created in ISO8601 format |
