...
Custom fields values for ACC Build Submittal items.
...
| 9 | created_at | timestamp: SQL |  | Date and time when the custom attribute value was added |
| 10 | created_by | string |  | Autodesk User ID of the user that added the custom attribute value |
| 11 | updated_at | timestamp: SQL |  | Date and time when the custom attribute value updated |
| 12 | updated_by | string |  | Autodesk User ID of the user that last updated the custom attribute value |
| 13 | deleted_at | timestamp: SQL |  | Date and time when the custom attribute value got deleted |
| 14 | select_value | string |  | Display field for single / multi select parameter type values. |

## item_revision

Submittal item revision for the ACC Build system.
...
| 10 | created_at | timestamp: SQL |  | when was the item created |
| 11 | updated_at | timestamp: SQL |  | last time the item was updated |
...
| 56 | pending_actions_from | string |  | Array of Autodesk User, Roles and Companies that have yet to respond |
...
Project custom fields of ACC Build Submittals.
...
| 9 | created_at | timestamp: SQL |  | Date and time when the parameter was detached from collection |
| 10 | created_by | string |  | Autodesk User ID of the user that detached that parameter |
| 11 | updated_at | timestamp: SQL |  | Date and time when the parameter was attached/detached to/from collection |
| 12 | updated_by | string |  | Autodesk User ID of the user that last updated the parameter for collection |
| 13 | deleted_at | timestamp: SQL |  | Date and time when the parameter was attached/detached to/from collection |
