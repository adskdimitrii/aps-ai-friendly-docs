# cdcmarkups Schema Description

Source: https://developer.api.autodesk.com/data-connector/v1/doc/schema?name=cdcmarkups&format=html
...
**Beta Release**  
This is a Beta release of the cdcmarkups data set and schema definitions are subject to change or even possibly be removed from the final data set release. Thank you for your understanding with any future schema updates.

## layer

Markups are placed on layers. which are placed on surfaces. - This is the Change Data Capture (CDC) enabled version of the markups.layer table.  Date Range Extractions Supported
...
Indicates if a markup is linked to another feature entity. - This is the Change Data Capture (CDC) enabled version of the markups.link table.  Date Range Extractions Supported
...
| 9 | created_at | timestamp: SQL |  | Date and time the link was created in ISO8601 format Column used for filtering Date Range Extraction requests |
...
| 12 | deleted_at | timestamp: SQL |  | Date and time the link was deleted in ISO8601 format Column used for filtering Date Range Extraction requests |
| 13 | updated_at | timestamp: SQL |  | Timestamp when the row was updated Column used for filtering Date Range Extraction requests |
| 14 | adsk_row_id | string |  | Unique row identifier to be used in CDC operations |

## markup

Main table for all our markup data. - This is the Change Data Capture (CDC) enabled version of the markups.markup table.  Date Range Extractions Supported
...
| 9 | created_at | timestamp: SQL |  | Date and time the markup was created in ISO8601 format Column used for filtering Date Range Extraction requests |
| 10 | updated_by | string |  | Autodesk User ID of the user who updated the markup. |
| 11 | updated_at | timestamp: SQL |  | Date and time the markup was updated in ISO8601 format Column used for filtering Date Range Extraction requests |
...
| 14 | deleted_at | timestamp: SQL |  | Date and time the markup was deleted in ISO8601 format Column used for filtering Date Range Extraction requests |
...
Combined with markup table to place markups on layers and surfaces. - This is the Change Data Capture (CDC) enabled version of the markups.placement table.  Date Range Extractions Supported
...
| 10 | created_at | timestamp: SQL |  | Date and time the placement was created in ISO8601 format Column used for filtering Date Range Extraction requests |
| 11 | updated_by | string |  | Autodesk User ID of the user who updated the placement. |
| 12 | updated_at | timestamp: SQL |  | Date and time the placement was updated in ISO8601 format Column used for filtering Date Range Extraction requests |
