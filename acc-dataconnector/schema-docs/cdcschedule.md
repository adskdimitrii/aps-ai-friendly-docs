...
The Workplan commitments in ACC Build  Date Range Extractions Supported
...
| 7 | root_cause_id | string: UUID |  | The root cause ID when commitment is incomplete or replanned |
| 8 | task_type | string |  | The task type when the task was committed |
| 9 | work_type | string |  | The work type when the task was committed |
| 10 | status | string |  | The status when the task was committed |
| 11 | start_date | date: string |  | The start date of the commitment |
| 12 | finish_date | date: string |  | The finish date of the commitment |
| 13 | duration | number |  | The duration of the commitment in working days |
| 14 | assigned_member_id | string: null |  | The member ID who committed to the task |
| 15 | assigned_company_id | string: null |  | The company ID who committed to the task |
...
| 19 | crew_size | number |  | The crew size for the commitment |
...
| 27 | deleted_at | timestamp: SQL |  | Timestamp when the row was deleted Column used for filtering Date Range Extraction requests |
| 28 | adsk_row_id | string |  | Unique row identifier to be used in CDC operations |

## plan_handoffs

The Workplan task handoffs in ACC Build  Date Range Extractions Supported
...
| 11 | deleted_at | timestamp: SQL |  | Timestamp when the dependencie was deleted Column used for filtering Date Range Extraction requests |
| 12 | adsk_row_id | string |  | Unique row identifier to be used in CDC operations |

## plan_plans

The Workplan plans in ACC Build  Date Range Extractions Supported
...
The Workplan project settings in ACC Build  Date Range Extractions Supported
...
The Workplan tasks comments in ACC Build  Date Range Extractions Supported
...
| 8 | updated_at | timestamp: SQL |  | Creation time of the task comment |
| 9 | created_by | string |  | The user who created the task comment |
| 10 | deleted_at | timestamp: SQL |  | Timestamp when the schedule was deleted Column used for filtering Date Range Extraction requests |
| 11 | adsk_row_id | string |  | Unique row identifier to be used in CDC operations |

## plan_tasks

The Workplan tasks in ACC Build  Date Range Extractions Supported
...
| 6 | activity_unique_id | number |  | Foreign Key: Table: schedule_activities Column: unique_id |
...
| 9 | work_type | string |  | The work type / sub-type of the task |
| 10 | status | string |  | The current status of the task |
| 11 | title | string |  | The task title / name |
...
| 25 | commitments_count | number |  | The number of commitments on the task |
...
| 31 | archived_at | timestamp: SQL |  | Timestamp when the schedule was archived |
| 32 | deleted_at | timestamp: SQL |  | Timestamp when the schedule was deleted Column used for filtering Date Range Extraction requests |
| 33 | adsk_row_id | string |  | Unique row identifier to be used in CDC operations |
