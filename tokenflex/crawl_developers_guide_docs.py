...
ROOT_URL = "https://aps.autodesk.com/en/docs/tokenflex/v1/developers_guide/overview/"
CUSTOM_JS_URL = "https://aps.autodesk.com/params/custom.js"
CONFIG_FILENAME = "tokenflex_v1.json"
...
def collect_guide_leaf_nodes(config: dict) -> list[dict]:
    ...
    while queue:
        ...
        if full_path.startswith("tokenflex/developers_guide/") and source:
            leaves.append(
                {
                    "full_path": full_path,
                    "url_path": url_path,
...
def main() -> None:
    ...
    index_lines = [
        "# Token Flex Developer's Guide URLs",
        "",
