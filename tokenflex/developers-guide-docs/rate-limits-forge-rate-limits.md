...
Source: https://aps.autodesk.com/en/docs/tokenflex/developers_guide/rate-limits/forge-rate-limits/
...
If a rate limit or quota causes problems for an application with reasonable resource use, you can request a limit or quota change by sending an email to [aps.help@autodesk.com](mailto:aps.help%40autodesk.com).
