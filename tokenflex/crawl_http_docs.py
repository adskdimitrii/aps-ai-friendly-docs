...
ROOT_URL = "https://aps.autodesk.com/en/docs/tokenflex/v1/reference/http/"
...
def collect_http_leaf_nodes(config: dict) -> list[dict]:
    ...
    while queue:
        ...
        if full_path.startswith("tokenflex/reference/http/") and source:
            leaves.append(
                {
                    "full_path": full_path,
                    "url_path": url_path,
