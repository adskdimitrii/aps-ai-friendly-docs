...
ROOT_URL = "https://aps.autodesk.com/en/docs/design-automation/v3/reference/http/"
...
def collect_http_leaf_nodes(config: dict) -> list[dict]:
    ...
    while queue:
        ...
        if full_path.startswith("design-automation/reference/http/") and source:
            leaves.append(
                {
                    "full_path": full_path,
                    "url_path": url_path,
...
def main() -> None:
    ...
    index_lines = [
        "# Design Automation HTTP API Doc URLs",
        "",
