...
Method and URI GET https://developer.api.autodesk.com/da/us-east/v3/activities/:id/aliases/:aliasId Authentication Context app only Required OAuth Scopes code:all Data Format JSON
...
200 OK Successfully get the details of an Activityâs alias. 403 Forbidden Unauthorized 404 Not Found Not found. 500 Internal Server Error Unknown error.
...
```
curl - v 'https://developer.api.autodesk.com/da/us-east/v3/activities/:id/aliases/:aliasId' \ - H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```
