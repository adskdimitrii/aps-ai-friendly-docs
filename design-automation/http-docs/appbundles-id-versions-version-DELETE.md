...
Method and URI DELETE https://developer.api.autodesk.com/da/us-east/v3/appbundles/:id/versions/:version Authentication Context app only Required OAuth Scopes code:all Data Format JSON
...
id string Name of AppBundle (unqualified). version int Version to delete (as integer).
...
```
curl - v 'https://developer.api.autodesk.com/da/us-east/v3/appbundles/:id/versions/:version' \ - X 'DELETE' \ - H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```
