...
| Method and URI | GET https://developer.api.autodesk.com/da/us-east/v3/appbundles/:id/versions/:version |
| --- | --- |
...
| --- | --- |
| version   int | Version to retrieve (as integer). |
...
- versionint The verison retrieved.
