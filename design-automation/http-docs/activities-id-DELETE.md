...
Method and URI DELETE https://developer.api.autodesk.com/da/us-east/v3/activities/:id Authentication Context app only Required OAuth Scopes code:all Data Format JSON
...
```
curl - v 'https://developer.api.autodesk.com/da/us-east/v3/activities/:id' \ - X 'DELETE' \ - H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```
