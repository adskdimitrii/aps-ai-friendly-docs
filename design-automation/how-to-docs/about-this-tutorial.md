...
Source: https://aps.autodesk.com/en/docs/design-automation/v3/tutorials/fusion/about-this-tutorial/

---

# About this Walkthrough

This walkthrough guides you through the process of loading a Fusion add-in and working with a Fusion file. It doesnât teach you how to create Fusion add-ins. Instead, it points you to resources that can teach you how to create them (See [Task 3](/en/docs/design-automation/v3/tutorials/fusion/task3-upload-appbundle)).
...
[Postman](https://www.getpostman.com/) is a popular tool that provides an easy-to-use interface to send HTTP requests. [The Postman walkthrough](https://github.com/autodesk-platform-services/aps-tutorial-postman/blob/master/DA4Fusion/collections/fusion_collections.zip) comes with a collection of pre-populated HTTP requests that you can modify.
