...
| *Newtonsoft.Json.dll* | A file referenced by the C# project that built the add-in. It enables the add-in to capture user input by way of a JSON file. You will use this capability in [Task 6](/en/docs/design-automation/v3/tutorials/inventor/task6-post-workitem) of this walkthrough to specify the new height and width to resize the input Inventor part or assembly. |
...
| --- | --- | --- |
| `Autodesk.Inventor+23` | Inventor 2019 | âengineâ: âAutodesk.Inventor+23â |
| `Autodesk.Inventor+24` | Inventor 2020 | âengineâ: âAutodesk.Inventor+24â |
| `Autodesk.Inventor+2021` | Inventor 2021 | âengineâ: âAutodesk.Inventor+2021â |
| `Autodesk.Inventor+2022` | Inventor 2022 | âengineâ: âAutodesk.Inventor+2022â |
| `Autodesk.Inventor+2023` | Inventor 2023 | âengineâ: âAutodesk.Inventor+2023â |
| `Autodesk.Inventor+2024` | Inventor 2024 | âengineâ: âAutodesk.Inventor+2024â |
...
- The exact versions of the Inventor engines currently deployed are listed on [the Inventor Release Notes page](/en/docs/design-automation/_change_history/inventor_release_notes).
