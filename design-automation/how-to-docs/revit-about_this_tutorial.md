...
It requires you to modify C# code. If you are not proficient in C#, you can download the Automation API ready add-in *DeleteWalls.dll* from [here](https://github.com/autodesk-platform-services/aps-tutorial-postman/tree/master/DA4Revit/walkthrough_data), and start from Task 2.

## [Postman walkthrough](#postman-walkthrough)

[Postman](https://www.getpostman.com/) is a popular tool that provides an easy-to-use interface to send HTTP requests.
