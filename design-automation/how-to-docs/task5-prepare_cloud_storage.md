...
For more information on the OSS, refer the Data Management API documentation .
...
```
{ "bucketKey" : "<YOUR_BUCKET_KEY>" , "bucketOwner" : "<YOUR_APP_CLIENT_ID>" , "createdDate" : 1571296694595 , "permissions" : [ { "authId" : "T05H372IE11Kmkksdh73ndj0qie2f6nib" , "access" : "full" } ], "policyKey" : "transient" }
```
...
- Download the file Mechanical - Multileaders.dwg from https://github.com/autodesk-platform-services/aps-tutorial-postman/tree/master/DA4ACAD/walkthrough_data .
...
```
{ "uploadKey" : "<YOUR_UPLOAD_KEY>" , "uploadExpiration" : "2022-02-05T00:00:00Z" , "urlExpiration" : "2022-02-03T05:23:29Z" , "urls" : [ "<SIGNED_UPLOAD_URL>" ] }
```
...
```
curl - X PUT \ "<SIGNED_UPLOAD_URL>" \ -- data - binary '@<PATH_TO_FILE_TO_UPLOAD>/Mechanical - Multileaders.dwg'
```
...
```
{ "bucketKey" : "<YOUR_BUCKET_KEY>" , "objectId" : "urn:adsk.objects:os.object:<YOUR_BUCKET_KEY>/<OBJECT_KEY_4_INPUT_FILE>" , "objectKey" : "<OBJECT_KEY_4_INPUT_FILE>" , "size" : 88612 , "contentType" : "application/octet-stream" , "location" : "https://developer.api.autodesk.com/oss/v2/buckets/<YOUR_BUCKET_KEY>/objects/<YOUR_OBJECT_KEY>" }
```
