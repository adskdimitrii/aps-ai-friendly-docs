...
This walkthrough guides you through the process of loading an Inventor add-in and resizing an Inventor part or assembly. It doesn’t teach you how to create Inventor add-ins. Instead, it points you to resources that can teach you how to create them (See [Task 3](inventor-task3-upload-appbundle.md)).
