...
This walkthrough guides you through the process of loading an Inventor add-in and resizing an Inventor part or assembly. It doesnât teach you how to create Inventor add-ins. Instead, it points you to resources that can teach you how to create them (See [Task 3](/en/docs/design-automation/v3/tutorials/inventor/task3-upload-appbundle)).
