...
ROOT_URL = "https://aps.autodesk.com/en/docs/aecdatamodel/v1/tutorials/"
...
def collect_tutorial_leaf_nodes(config: dict) -> list[dict]:
    ...
    while queue:
        ...
        if full_path.startswith("aecdatamodel/tutorials/") and source:
            leaves.append(
                {
                    "full_path": full_path,
                    "url_path": url_path,
