...
Before you begin, follow the [Create an App](create-app.md) walkthrough to create your app on the APS Platform. Specify your app’s callback URL and note your client ID and secret.
...
## [Step 2: Implement Code that Extracts the Authorization Code](#step-2-implement-code-that-extracts-the-authorization-code)
