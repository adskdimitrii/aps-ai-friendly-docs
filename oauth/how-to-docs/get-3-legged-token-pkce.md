...
Source: https://aps.autodesk.com/en/docs/oauth/v2/tutorials/get-3-legged-token-pkce/get-3-legged-token-pkce/
...
Before you begin, follow the Create an App walkthrough. Refer to the section, Step 2: Register an App and select Desktop, Mobile, Single-Page App to create your app on the APS developer Platform. Specify your appâs callback URL and note your client ID.
