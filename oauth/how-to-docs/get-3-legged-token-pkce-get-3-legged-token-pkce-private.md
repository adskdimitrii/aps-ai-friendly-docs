...
Before you begin, follow the [Create an App](create-app.md) walkthrough. Refer to the section, Step 2: Register an App and select Traditional Web App to create your app on the APS developer Platform. Specify your appâs callback URL and note your client ID and secret.
