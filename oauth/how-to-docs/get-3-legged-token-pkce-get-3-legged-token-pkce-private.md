...
Before you begin, follow the [Create an App](/en/docs/oauth/v2/tutorials/create-app) walkthrough. Refer to the section, Step 2: Register an App and select Traditional Web App to create your app on the APS developer Platform. Specify your appâs callback URL and note your client ID and secret.
...
## [Step 2: Implement Code that Extracts the Authorization Code with PKCE](#step-2-implement-code-that-extracts-the-authorization-code-with-pkce)
