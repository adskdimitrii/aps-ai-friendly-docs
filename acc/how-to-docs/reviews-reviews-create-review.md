...
- If you need to inspect the review’s steps and progress, use [GET reviews/workflow](../http-docs/http-reviews-getreviewworkflow-GET.md) for the workflow snapshot or [GET reviews/progress](../http-docs/http-reviews-getreviewprogress-GET.md) for progress updates.
...
- The `payload` includes the review’s creation status.
