...
Source: https://aps.autodesk.com/en/docs/acc/tutorials/issues/retrieve-issues/
...
Use the project ID ( f6a1e3b5-abaa-4b01-b33a-5d55f36ba047 ) to retrieve the projectâs issues, by calling GET issues .
