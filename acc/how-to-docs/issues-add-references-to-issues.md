...
## [Step 2: Find the Issue ID](#step-2-find-the-issue-id)

To find the issue ID of the issue you want to add the photo to, call [`GET issues /en/docs/acc/v1/reference/http/issues-issues-GET/`_](#id7) using the project ID (`f6a1e3b5-abaa-4b01-b33a-5d55f36ba047`).
