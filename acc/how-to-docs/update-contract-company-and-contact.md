...
Find the ID of the contract you want to update by calling GET Contracts . In this example, assume that the container ID is e94b9bc8-1775-4d76-9b1d-c613e120ccff .
...
## Step 2: Get the Projectâs Companies from BIM 360 Admin

Use the project ID ( 18ece8b1-204d-11e8-ad71-d73b169f902a ) and account ID( aade5ed8-f16d-4ec0-9c0a-59f5ff7a2134 ) to call GET companies to get the projectâs companies and find the member_group_id of the company you want.
...
Use the container ID ( e94b9bc8-1775-4d76-9b1d-c613e120ccff ), contract ID( 55254a50-44d9-11e9-99d7-79aa05d3109e ), and company ID ( 764893 ) noted above to call PATCH contracts/:id to update the contract.
...
```
{ "id" : "f6445638-ca68-4e3c-9160-15864de6b818" , "code" : "GC-01" , "name" : "Site Management Staff" , "description" : "Site Management Staff" , "companyId" : "764893" , "type" : "consultant" , "..." : "..." }
```
