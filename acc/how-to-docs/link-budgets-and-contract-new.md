...
To find a list of contracts you want to link to, use the containter ID ( 18ece8b1-204d-11e8-ad71-d73b169f902a ), to call GET Contracts .
...
```
{ "results" : [ { "id" : "55254a50-44d9-11e9-99d7-79aa05d3109e" , "name" : "Contract 1" , "..." : "..." , }, { "id" : "55254a50-44d9-11e9-99d7-79aa05d3109f" , "name" : "Contract 2" , "..." : "..." , } ], "pagination" : { "totalResults" : 2 , "limit" : 100 , "offset" : 0 } }
```
...
To find the IDs of the budgets you want to link to the contract, use the containter ID ( 18ece8b1-204d-11e8-ad71-d73b169f902a ), to call GET Budgets .
...
```
{ "results" : [ { "name" : "Doors" , "id" : "5573e292-4355-4d00-a204-2cba97b7025a" , "..." : "..." , }, { "name" : "Windows" , "id" : "f7840135-dd11-45d2-9b54-b0887ab3c29b" , "..." : "..." , }, { "name" : "Flooring" , "id" : "f7840135-dd11-45d2-9b54-b0887ab3c29c" , "..." : "..." , } ], "pagination" : { "totalResults" : 3 , "limit" : 100 , "offset" : 0 } }
```
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/18ece8b1-204d-11e8-ad71-d73b169f902a/budgets-contracts:link' -d '{ "create": [ { "budgetId": "5573e292-4355-4d00-a204-2cba97b7025a", "contractId": "55254a50-44d9-11e9-99d7-79aa05d3109e" }, { "budgetId": "f7840135-dd11-45d2-9b54-b0887ab3c29b", "contractId": "55254a50-44d9-11e9-99d7-79aa05d3109e" }, { "budgetId": "f7840135-dd11-45d2-9b54-b0887ab3c29c", "contractId": "55254a50-44d9-11e9-99d7-79aa05d3109f" }, ] }' -X 'POST' \ -H 'Content-Type: application/json' \ -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsImtpZCI6Imp3dF9zeW1tZXRyaWNfa2V5In0'
```
...
Note that you can also unlink budgets to contracts. For more information, see POST budgets-contracts:link .
