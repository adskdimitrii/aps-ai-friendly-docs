...
## [Step 3: Find the RFI Virtual Folder ID](#step-3-find-the-rfi-virtual-folder-id)
...
## [Step 6: Upload a File to the Signed URL](#step-6-upload-a-file-to-the-signed-url)
...
## [Step 8: Assign the Attachment to a Response](#step-8-assign-the-attachment-to-a-response)
