...
ROOT_URL = "https://aps.autodesk.com/en/docs/acc/v1/tutorials/getting-started/"
CUSTOM_JS_URL = "https://aps.autodesk.com/params/custom.js"
CONFIG_FILENAME = "acc_v1.json"
...
def collect_howto_leaf_nodes(config: dict) -> list[dict]:
    ...
    while queue:
        ...
        if full_path.startswith("acc/tutorials/") and source:
            leaves.append(
                {
                    "full_path": full_path,
                    "url_path": url_path,
...
def main() -> None:
    ...
    index_lines.extend(f"- https://aps.autodesk.com/en/docs/{node['full_path']}/" for node in leaf_nodes)
