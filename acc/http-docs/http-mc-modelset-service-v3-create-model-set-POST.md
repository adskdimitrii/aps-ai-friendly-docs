...
| Method and URI | POST https://developer.api.autodesk.com/bim360/modelset/v3/containers/:containerId/modelsets |
| --- | --- |
...
| modelSetId   string: UUID | The GUID that uniquely identifies the model set. If this value is not supplied a new GUID is created. |
| --- | --- |
...
| folders*   array: object | A single folder URN that contains a set of document lineages that are added to the model set. Min items: 1 Max items: 1. |
