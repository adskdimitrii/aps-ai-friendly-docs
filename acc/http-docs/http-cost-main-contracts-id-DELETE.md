...
- idarray: string The object ID of the main contract. You can obtain this ID from the response to the [POST mainContract](http-cost-main-contracts-POST.md) or [GET mainContract](http-cost-main-contracts-GET.md) endpoint.
