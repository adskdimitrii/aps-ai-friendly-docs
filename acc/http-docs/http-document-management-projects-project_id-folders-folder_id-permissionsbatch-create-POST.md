...
For details about updating a userâs permissions, see the [Update a Userâs Folder Permissions](https://aps.autodesk.com/en/docs/bim360/v1/tutorials/update-permissions/) tutorial.
...
| subjectId*   string: UUID | The ID of the user, role, or company. To verify the subjectId: <br>For a user, use [GET users](https://aps.autodesk.com/en/docs/bim360/v1/reference/http/admin-v1-projects-projectId-users-GET/).For a role, use [GET roles](https://aps.autodesk.com/en/docs/bim360/v1/reference/http/projects-project_id-industry_roles-GET/)For a company, use [GET companies](http-projects--project_id-companies-GET.md) |
| --- | --- |
