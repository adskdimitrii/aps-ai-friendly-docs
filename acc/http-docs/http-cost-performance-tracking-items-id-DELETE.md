...
| --- | --- |
| id   array: string: uuid | The ID of the budget on which the tracking item to be deleted is based. To find the budget IDs, call [GET performance-tracking-items](http-cost-performance-tracking-items-GET.md) and inspect `results.budgetId` in the response. |
