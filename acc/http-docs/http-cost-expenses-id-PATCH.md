...
- idarray: string The unique ID of the expense. You can obtain this ID from the response to the [POST expenses](/en/docs/bim360/v1/reference/http/cost-expenses-POST/) or [GET expenses](/en/docs/bim360/v1/reference/http/cost-expenses-GET/) endpoint.
