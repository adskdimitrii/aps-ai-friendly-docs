...
- expenseIdarray: string A list of the object IDs of the expenses whose items you want to retrieve, separated by commas. You can obtain these IDs from the response to the [POST expenses](http-cost-expenses-POST.md) or [GET expenses](http-cost-expenses-GET.md) endpoint.
