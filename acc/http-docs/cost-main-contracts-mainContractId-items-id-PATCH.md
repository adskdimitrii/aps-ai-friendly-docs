...
Method and URI PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/main-contracts/:mainContractId/items/:id Authentication Context user context required Required OAuth Scopes data:write Data Format JSON
...
Possible values: amount , quantity , and unitPrice .
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/main-contracts/f6445638-ca68-4e3c-9160-15864de6b818/items/1df59db0-9484-11e8-a7ec-7ddae203e404' \ -X 'PATCH' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a' \ -H 'Content-Type: application/json' \ -d '{ "code": 1011, "name": "Site Management Staff", "description": "Site Management Staff", "unit": "ea", "lockedField": "amount", "unitPrice": "1000.0000", "quantity": "1000.0000", "amount": "1000.0000", "position": 1, "externalId": "10010-99-AB", "externalSystem": "Sage300", "externalMessage": "Success.", "lastSyncTime": "2019-09-05T01:00:12.989Z", "integrationState": "locked" }'
```
