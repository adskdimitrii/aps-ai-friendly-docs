# v1/containers/{containerId}/attachments/{attachmentId}

Source: https://aps.autodesk.com/en/docs/acc/reference/http/cost-attachments-attachmentId-DELETE/
...
Method and URI DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/attachments/:attachmentId Authentication Context user context required Required OAuth Scopes data:write Data Format JSON
...
containerId string: UUID The ID of the project (the container ID is the same as the project ID). To obtain the project ID, see GET projects . attachmentId string The attachment ID.
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/attachments/18d97ae0-9484-11e8-a7ec-7ddae203e404' \ -X 'DELETE' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```
