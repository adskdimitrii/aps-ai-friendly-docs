...
| lockedFields   string,null | The locked performance tracking item instance field. You can lock the performance tracking item instanceâs planned total (`plannedTotal`) when calculating a item instance if youâre updating a single value. |
