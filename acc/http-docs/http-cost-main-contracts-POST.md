...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/cost-main-contracts-POST/
...
| Method and URI | POST https://developer.api.autodesk.com/cost/v1/containers/:containerId/main-contracts |
| --- | --- |
...
| ownerCompanyId   string,null | The BIM360/Forma ID of the owner company. |
| ownerContactId   string,null | The BIM360/Forma ID of the primary contact at the owner company. |
| architectCompanyId   string,null | The BIM360/Forma ID of the architecture firm. |
