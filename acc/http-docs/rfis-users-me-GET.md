...
| user   object | The current userâs details. |
| --- | --- |
| id   string | The Autodesk ID of the user. |
| name   string | The name of the user. |
| role   enum:string | The userâs role in the project. Possible values: `project_user`, `project_admin`. |
| permittedActions   object | The list of actions that are permitted for the user. |
| createRfi   object | The userâs permissions for creating RFIs. <br>Note that if this field is present, the user is permitted to create RFIs in the project. |
