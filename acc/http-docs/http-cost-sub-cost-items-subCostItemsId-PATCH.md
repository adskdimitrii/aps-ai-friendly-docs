...
| subCostItemsId   string: UUID | The ID of the sub cost item to be updated. To find the sub cost item ID, call [GET sub-cost-items](http-cost-sub-cost-items-GET.md). |
