...
For details on validating custom identifiers in the Submittal workflow, see the [Create Submittal Item](/en/docs/acc/v1/tutorials/submittals/create-submittal-item) tutorial.
