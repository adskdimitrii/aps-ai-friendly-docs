...
To retrieve full information for a specific RFI, use [GET rfis/:id](/en/docs/acc/v1/reference/http/rfis-rfis-id-GET).
...
| assignedTo   array: string | Filter RFIs assigned to specific users. <br>To find the ID call [GET users/me](/en/docs/bim360/v1/reference/http/rfis-users-me-GET/) and check `user.id`. |
| locations   array: string | Filter RFIs by location using Location Breakdown Structure (LBS) node IDs. <br>To retrieve location IDs, call [GET nodes](/en/docs/acc/v1/reference/http/locations-nodes-GET/).â |
...
| createdBy   array: string | Filter RFIs by the user who created them. <br>To find the ID call [GET users/me](/en/docs/bim360/v1/reference/http/rfis-users-me-GET/) and check `user.id`.â |
...
| id   array: string | Filter by a list of specific RFI IDs. <br>To find the RFI IDs call [GET rfis](/en/docs/bim360/v1/reference/http/rfis-v2-rfis-GET/) and check `results.id`. |
