...
| id   array: string: uuid | A list of the object IDs of the expense items whose items you want to retrieve, separated by commas. You can obtain these IDs from the response to the [POST expenses/:expenseId/items](http-cost-expenses-expenseId-items-POST.md) or [GET expenses/:expenseId/items](http-cost-expenses-expenseId-items-GET.md) endpoint. |
