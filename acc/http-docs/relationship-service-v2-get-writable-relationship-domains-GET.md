...
Method and URI GET https://developer.api.autodesk.com/bim360/relationship/v2/utility/relationships:writable Authentication Context user context required Required OAuth Scopes data:read Data Format JSON
...
domain string The domain to which the entity types belong. For example: autodesk-bim360-asset To learn more about domains and entities, see the Relationship Service Field Guide . entityTypes array: object The list of entity types in the domain. entityType string An individual entity type. For example: asset . allow array: object The allow list for the entity type. domain string The domain containing the allowed entity types. entityTypes array: string The allowed entity types.
...
```
[ { "domain" : "autodesk-bim360-asset" , "entityTypes" : [ { "entityType" : "asset" , "allow" : [ { "domain" : "autodesk-bim360-documentmanagement" , "entityTypes" : [ "documentlineage" ] } ] } ] } ]
```
