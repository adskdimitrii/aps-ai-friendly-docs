...
To retrieve the exact workflow that was applied to a specific review, call [GET reviews/:reviewId/workflow](/en/docs/acc/v1/reference/http/reviews-getreviewworkflow-GET/).
