...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/mc-clash-service-v3-get-model-set-version-clash-tests-GET/
...
Method and URI GET https://developer.api.autodesk.com/bim360/clash/v3/containers/:containerId/modelsets/:modelSetId/versions/:version/tests Authentication Context user context required Required OAuth Scopes data:read Data Format JSON
...
```
curl -v 'https://developer.api.autodesk.com/bim360/clash/v3/containers/f0f4f36a-ac64-687f-b132-8efe04b22454/modelsets/00fb28a5-e8a4-2755-562a-7c2f0fc87911/versions/42/tests' \ -H 'Authorization: Bearer <token>'
```
...
```
curl -v 'https://developer.api.autodesk.com/bim360/clash/v3/containers/f0f4f36a-ac64-687f-b132-8efe04b22454/modelsets/00fb28a5-e8a4-2755-562a-7c2f0fc87911/versions/42/tests?status=Success&pageLimit=134&continuationToken=10' \ -H 'Authorization: Bearer <token>'
```
