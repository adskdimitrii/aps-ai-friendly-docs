...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/users-:user_id-GET/
...
Method and URI GET https://developer.api.autodesk.com/hq/v1/accounts/:account_id/users/:user_id Method and URI (Legacy) GET https://developer.api.autodesk.com/hq/v1/regions/eu/accounts/:account_id/users/:user_id Authentication Context app only Required OAuth Scopes account:read Data Formats JSON
