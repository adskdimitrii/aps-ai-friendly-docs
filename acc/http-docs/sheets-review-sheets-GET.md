...
It enables you to review the sheets that you uploaded before publishing them. For more details, see the [Upload Sheets](/en/docs/acc/v1/tutorials/upload-sheets/) tutorial.
