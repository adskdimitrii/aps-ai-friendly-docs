...
| --- | --- |
| mainContractId   array: string: uuid | A list of the IDs of the main contracts from which to return items, separated by commas. To find the main contract IDs, call [GET main-contracts](http-cost-main-contracts-GET.md) and inspect `results.id` in the response. |
