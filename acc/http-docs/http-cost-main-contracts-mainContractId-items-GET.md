...
| Method and URI | GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/main-contracts/:mainContractId/items |
| --- | --- |
...
| --- | --- |
| mainContractId   array: string: uuid | A list of the IDs of the main contracts from which to return items, separated by commas. To find the main contract IDs, call [GET main-contracts](/en/docs/bim360/v1/reference/http/cost-main-contracts-GET/) and inspect `results.id` in the response. |
