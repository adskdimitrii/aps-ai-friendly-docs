...
To learn more about using this endpoint within the submittal workflow, see the [Process Submittal Items tutorial](https://aps.autodesk.com/en/docs/acc/v1/tutorials/submittals/submittal-transitions.rst.rst/).
