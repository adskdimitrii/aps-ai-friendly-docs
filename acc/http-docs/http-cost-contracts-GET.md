...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/cost-contracts-GET/
...
| Method and URI | GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/contracts |
| --- | --- |
...
| filter[source]   string | Returns only items with the specified source. For example, [``](#id3)filter[source]=`urn:adsk.wipqa:bc.package:dekqaSc4SRK7AJ9YLVLCeg`. <br>Max length: 255 |
...
| results   array: object | The detailed contracts. |
