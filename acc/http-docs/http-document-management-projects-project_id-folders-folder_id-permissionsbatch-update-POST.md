...
Note that if the user has not been assigned any permissions for the folder, you need to use the [Assign permissions](/en/docs/bim360/v1/reference/http/document-management-projects-project_id-folders-folder_id-permissionsbatch-create-POST) endpoint.
