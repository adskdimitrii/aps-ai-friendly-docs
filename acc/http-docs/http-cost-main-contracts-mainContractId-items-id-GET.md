...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/cost-main-contracts-mainContractId-items-id-GET/
...
| Method and URI | GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/main-contracts/:mainContractId/items/:id |
| --- | --- |
...
| --- | --- |
| mainContractId   string: UUID | The ID of the main contract. To find the main contract ID, call [GET main-contracts](/en/docs/bim360/v1/reference/http/cost-main-contracts-GET/) and inspect `results.id` in the response. |
| id   string: UUID | The object ID of the item. To find the item IDs, call [GET main-contracts/:mainContractId/items](/en/docs/bim360/v1/reference/http/cost-main-contracts-mainContractId-items-GET/) and inspect `results.id` in the response. |

### Request

## [Query String Parameters](#query-string-parameters)

| include   array: string | A list of the types of nested resources to include in the response with the main contract items, separated by commas. <br>For example, `include=budget` returns the budgets that are associated with each returned main contract item.<br>Possible values: `budget`, `mainContract`. |
| --- | --- |
