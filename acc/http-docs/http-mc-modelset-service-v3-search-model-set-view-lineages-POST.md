...
| Method and URI | POST https://developer.api.autodesk.com/bim360/modelset/v3/containers/:containerId/modelsets/:modelSetId/views:lineages |
| --- | --- |
...
| exact   boolean | Determines whether to exactly match the set of lineages passed. |
| --- | --- |
