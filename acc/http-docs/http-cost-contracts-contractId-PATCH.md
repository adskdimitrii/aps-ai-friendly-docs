...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/cost-contracts-contractId-PATCH/
...
| Method and URI | PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/contracts/:contractId |
| --- | --- |
