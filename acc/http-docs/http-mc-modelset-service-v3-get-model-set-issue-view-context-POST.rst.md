...
The BIM360 Issues API can be used to obtain individual issues. See [GET issues/:issueId](https://aps.autodesk.com/en/docs/bim360/v1/reference/http/issues-v2-issues-issueId-GET/) for more information.
