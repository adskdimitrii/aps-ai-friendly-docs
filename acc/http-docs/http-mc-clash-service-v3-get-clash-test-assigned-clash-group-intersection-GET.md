...
| Method and URI | GET https://developer.api.autodesk.com/bim360/clash/v3/containers/:containerId/tests/:testId/clashes/assigned |
| --- | --- |
...
| pageLimit   int | The maximum number of assigned clash groups to return in a page. If not set, the default page limit is used, as determined by the server. |
| --- | --- |
...
| modelSetVersion   int | The model set version number. |
| groups   array: object | The list of clash groups intersected with the specified clash test. |
| id   string: UUID | The unique identifier of the clash group. |
| originalClashTestId   string: UUID | The unique identifier of the clash test originally associated with the clash group. |
| createdAtVersion   int | The model set version number associated with the original clash test. |
| existing   array: int | Clashes contained with the clash group that still exist within the specified clash test. |
| resolved   array: int | Clashes contained with the clash group that have been resolved. |
