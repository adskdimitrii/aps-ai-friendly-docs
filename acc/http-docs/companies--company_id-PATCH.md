...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/companies-:company_id-PATCH/
...
Method and URI PATCH https://developer.api.autodesk.com/hq/v1/accounts/:account_id/companies/:company_id Method and URI (Legacy) PATCH https://developer.api.autodesk.com/hq/v1/regions/eu/accounts/:account_id/companies/:company_id Authentication Context app only Required OAuth Scopes account:write Data Formats JSON
...
A successful response is the modified company, a flat JSON object with the following attributes:
...
Successful Updating Company (200)

### Request

```
curl -v 'https://developer.api.autodesk.com/hq/v1/accounts/80793a28-f9b1-4888-9533-5f00cddcd6fb/companies/fc830fd8-f1ef-4cd6-9163-fb115dc698d7' \ -X 'PATCH' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a' \ -H 'Content-Type: application/json' \ -d '{ "name": "Autodesk", "trade": "Concrete", "phone": "(503)623-1525" }'
```
