...
| Method and URI | POST https://developer.api.autodesk.com/construction/assets/v1/projects/{projectId}/asset-statuses:batch-get |
| --- | --- |
...
| results   array: object | Returned statuses |
| --- | --- |
