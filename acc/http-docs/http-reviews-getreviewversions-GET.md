...
Note that to export reviewing files using these version URNs, see [Step 3 in the PDF File Export](https://aps.autodesk.com/en/docs/acc/v1/tutorials/files/export-pdf-files/#step-3-export-the-files) tutorial.
