...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/issues-issues-POST/
...
This endpoint automatically triggers the issue.created-1.0 webhook event when a new issue is created. If youâve configured a webhook subscription for this event, your application will receive a notification. For more information, see the Issues Webhooks section in the Field Guide.

## Resource Information

Method and URI POST https://developer.api.autodesk.com/construction/issues/v1/projects/{projectId}/issues Authentication Context user context required Required OAuth Scopes data:write Data Format JSON
