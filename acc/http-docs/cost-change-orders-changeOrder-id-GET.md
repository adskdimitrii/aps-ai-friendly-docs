...
| id   string: UUID | The change orderâs ID. |
...
| creatorId   string | The BIM 360/ACC user ID of the commentâs author. For details about the author, see [GET users](/en/docs/acc/v1/reference/http/admin-projectsprojectId-users-GET/). |
