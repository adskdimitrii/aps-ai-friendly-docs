...
| --- | --- |
| id   string: UUID | The ID of the performance tracking item. To find the item ID, call [GET performance-tracking-items](/en/docs/bim360/v1/reference/http/cost-performance-tracking-items-GET) and inspect `results.id` in the response. |
