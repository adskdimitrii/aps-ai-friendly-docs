...
| Method and URI | POST https://developer.api.autodesk.com/construction/index/v2/projects/:projectId/indexes:batch-status |
| --- | --- |
...
| indexes   array: object | indexes. <br>Min items: 1 Max items: 1000 |
| --- | --- |
