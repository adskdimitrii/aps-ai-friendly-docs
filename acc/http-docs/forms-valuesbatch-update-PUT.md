...
See the [Manage Forms tutorial](/en/docs/acc/v1/tutorials/forms/create-update-forms/) for more details about how to update forms.

To update the formâs details, use [PATCH forms/:formId API](/en/docs/acc/v1/reference/http/forms-forms-formId-PATCH).
...
- formIdstring The unique identifier of the form. Use [GET forms](/en/docs/acc/v1/reference/http/forms-forms-GET/) to retrieve the form ID.
