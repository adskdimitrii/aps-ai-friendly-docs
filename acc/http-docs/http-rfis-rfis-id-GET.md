...
To check which RFI states a user can create RFIs in, and which attributes are required per state, use [GET users/me](http-rfis-users-me-GET.md).

For an overview of how RFIs work in the Forma web interface, see the [Help documentation](https://help.autodesk.com/view/BUILD/ENU/?guid=RFIs_Overview).
