# containers/:containerId/modelsets/:modelSetId/clashes/grouped

Source: https://aps.autodesk.com/en/docs/acc/reference/http/mc-clash-service-v3-get-grouped-clashes-GET/
...
Method and URI GET https://developer.api.autodesk.com/bim360/clash/v3/containers/:containerId/modelsets/:modelSetId/clashes/grouped Authentication Context user context required Required OAuth Scopes data:read Data Format JSON
...
clashes array: int The set of clashes that have been assigned or closed.
...
```
curl -v 'https://developer.api.autodesk.com/bim360/clash/v3/containers/f0f4f36a-ac64-687f-b132-8efe04b22454/modelsets/00fb28a5-e8a4-2755-562a-7c2f0fc87911/clashes/grouped' \ -H 'Authorization: Bearer <token>'
```
