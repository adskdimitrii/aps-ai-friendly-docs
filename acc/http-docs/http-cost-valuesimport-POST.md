...
| Method and URI | POST https://developer.api.autodesk.com/cost/v1/containers/:containerId/segments/:segmentId/values:import |
| --- | --- |
...
| data*   array: object | A list of segment values. |
| --- | --- |
...
| append   boolean | `true` append the imported segment values to the existing values. <br>`false` purge the existing segment values and replace them with the imported values. |
