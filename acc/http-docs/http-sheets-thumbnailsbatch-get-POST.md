...
| reviewSheetIds*   array: string | The IDs of the review sheets you want to get the thumbnails from. To find the review sheet IDs, call [GET review-sheets](http-sheets-review-sheets-GET.md). <br>The max number of items is 100. |
| --- | --- |
