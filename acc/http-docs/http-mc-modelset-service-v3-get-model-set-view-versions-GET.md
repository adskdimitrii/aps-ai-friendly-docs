...
| Method and URI | GET https://developer.api.autodesk.com/bim360/modelset/v3/containers/:containerId/modelsets/:modelSetId/versions/:version/views |
| --- | --- |
...
| modelSetViewVersions   array: object | The list of model set view versions. |
