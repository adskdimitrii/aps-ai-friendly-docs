# containers/:containerId/clashes/jobs/:jobId

Source: https://aps.autodesk.com/en/docs/acc/reference/http/mc-clash-service-v3-get-clash-group-job-GET/
...
Method and URI GET https://developer.api.autodesk.com/bim360/clash/v3/containers/:containerId/clashes/jobs/:jobId Authentication Context user context required Required OAuth Scopes data:read Data Format JSON
...
```
curl -v 'https://developer.api.autodesk.com/bim360/clash/v3/containers/f0f4f36a-ac64-687f-b132-8efe04b22454/clashes/jobs/49244371-ee08-9afa-01f8-26fcd8ecb03d' \ -H 'Authorization: Bearer <token>'
```
