...
| Method and URI | GET https://developer.api.autodesk.com/construction/submittals/v2/projects/:projectId/settings/mappings |
| --- | --- |
...
| results   array: object | A list of user-role mappings defined by administrators. |
...
| createdBy   string | Autodesk ID of the user who has created the project. |
| createdAt   datetime: ISO 8601 | When the record was created. |
