...
| --- | --- |
| rfiId   string | The ID of the RFI. To find the ID, call [POST search:rfis](/en/docs/acc/v1/reference/http/rfis-rfi-search-POST/). |
| responseId   string | The ID of the response. To find the ID, call [GET rfis/:id](/en/docs/acc/v1/reference/http/rfis-rfis-id-GET/). |
