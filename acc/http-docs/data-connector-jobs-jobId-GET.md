...
Method and URI GET https://developer.api.autodesk.com/data-connector/v1/accounts/:accountId/jobs/:jobId Authentication Context user context required Required OAuth Scopes data:write Data Format JSON
...
```
curl -v 'https://developer.api.autodesk.com/data-connector/v1/accounts/:accountId/jobs/:jobId' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```
