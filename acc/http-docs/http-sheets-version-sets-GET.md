...
To get a list of sheets that are associated with a version set, call [GET sheets](http-sheets-sheets-GET.md) with the `filter[versionSetId]`.

Note that this endpoint is not compatible with BIM 360 projects.

## [Resource Information](#resource-information)

| Method and URI | GET https://developer.api.autodesk.com/construction/sheets/v1/projects/{projectId}/version-sets |
| --- | --- |
