...
To get a list of sheets that are associated with a version set, call [GET sheets](/en/docs/acc/v1/reference/http/sheets-sheets-GET/) with the `filter[versionSetId]`.
