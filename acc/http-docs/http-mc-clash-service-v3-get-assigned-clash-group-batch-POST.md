...
| Method and URI | POST https://developer.api.autodesk.com/bim360/clash/v3/containers/:containerId/tests/:testId/clashes/assigned |
| --- | --- |
...
| issueId   string: UUID | The unique identifier of the issue associated with the assigned clash group. |
