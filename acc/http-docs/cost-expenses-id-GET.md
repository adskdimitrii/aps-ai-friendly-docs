...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/cost-expenses-id-GET/
...
Method and URI GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/expenses/:id Authentication Context user context required Required OAuth Scopes data:read Data Format JSON
