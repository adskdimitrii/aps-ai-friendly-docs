...
Retrieves a list of review sheets. This endpoint is typically used during the process of uploading files to the [Forma Sheets tool](https://help.autodesk.com/view/BUILD/ENU/?guid=Upload_And_Publish_Sheets).
