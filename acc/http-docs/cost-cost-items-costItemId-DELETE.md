...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/cost-cost-items-costItemId-DELETE/
...
Method and URI DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/cost-items/:costItemId Authentication Context user context required Required OAuth Scopes data:write Data Format JSON
...
containerId string: UUID The ID of the project (the container ID is the same as the project ID). To obtain the project ID, see GET projects . costItemId array: string The cost item ID
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/cost-items/:costItemId' \ -X 'DELETE' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```
