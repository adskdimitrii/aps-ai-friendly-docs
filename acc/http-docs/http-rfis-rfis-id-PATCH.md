...
| storageUrn*   string | The ID (URN) of the attachment in ACC Docs. <br>Attachments are stored in the project’s virtual folder. To upload the attachment, see the [Upload Attachments to RFIs tutorial](LINK_TO_TUTORIAL). |
