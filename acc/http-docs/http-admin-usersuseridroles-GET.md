...
Only users with account admin permissions can call this endpoint. To verify a userâs permissions, call [GET users](http-admin-projectsprojectId-users-GET.md).
