...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/cost-main-contracts-mainContractId-items-id-DELETE/
...
Method and URI DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/main-contracts/:mainContractId/items/:id Authentication Context user context required Required OAuth Scopes data:write Data Format JSON
...
containerId string: UUID The ID of the project (the container ID is the same as the project ID). To obtain the project ID, see GET projects . mainContractId string: UUID The ID of the main contract. To find the main contract ID, call GET main-contracts and inspect results.id in the response. id array: string The object ID of the main contract item. You can obtain this ID from the response to the POST mainContractItems or GET mainContract endpoint.
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/main-contracts/f6445638-ca68-4e3c-9160-15864de6b818/items/1df59db0-9484-11e8-a7ec-7ddae203e404' \ -X 'DELETE' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```
