...
| ids*   array: string | To find the IDs of the sheets you want to update, call [GET sheets](/en/docs/acc/v1/reference/http/sheets-sheets-GET/). <br>The max number of items is 200. |
| --- | --- |
