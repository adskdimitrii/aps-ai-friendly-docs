...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/rfis-rfis-id-GET/
...
Method and URI GET https://developer.api.autodesk.com/construction/rfis/v3/projects/:projectId/rfis/:rfiId Authentication Context user context required Required OAuth Scopes data:read Data Format JSON
...
```
curl -v 'https://developer.api.autodesk.com/construction/rfis/v3/projects/:projectId/rfis/:rfiId' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```
