...
Retrieves information about all the collections in a project. You can use [GET sheets](/en/docs/acc/v1/reference/http/sheets-sheets-GET/) to return all the sheets associated with a specific collection.
