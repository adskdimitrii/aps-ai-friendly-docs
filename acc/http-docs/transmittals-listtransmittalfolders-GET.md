...
| updatedBy   string | The Autodesk ID of the user who last modified the folder. For details about the user, call [GET user](/en/docs/acc/v1/reference/http/admin-projectsprojectId-users-userId-GET/). |
