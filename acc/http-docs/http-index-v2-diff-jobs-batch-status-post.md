...
| Method and URI | POST https://developer.api.autodesk.com/construction/index/v2/projects/:projectId/diffs:batch-status |
| --- | --- |
...
| diffs*   array: object | diffs. <br>Min items: 1 Max items: 1000 |
| --- | --- |
| prevVersionUrn*   string | file version urn. |
| curVersionUrn*   string | file version urn. |
