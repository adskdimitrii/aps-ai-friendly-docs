...
| --- | --- |
| parentId*   string,null | The ID of the SOV item’s parent item. For root SOV items, this value is **null**. Root items can only be created when allocating a budget to a contract. |
