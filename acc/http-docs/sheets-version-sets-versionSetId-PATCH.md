...
To get a list of sheets that are associated with a version set, call [GET sheets](/en/docs/acc/v1/reference/http/sheets-sheets-GET/) with the version set ID filter (`filter[versionSetId]`).
...
- versionSetIdstring The ID of the version set. To find the version set ID, call [GET version-sets](/en/docs/acc/v1/reference/http/sheets-version-sets-GET/).
