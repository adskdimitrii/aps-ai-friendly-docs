# projects/{projectId}/version-sets/{versionSetId}

Source: https://aps.autodesk.com/en/docs/acc/reference/http/sheets-version-sets-versionSetId-PATCH/
...
Method and URI PATCH https://developer.api.autodesk.com/construction/sheets/v1/projects/{projectId}/version-sets/{versionSetId} Authentication Context user context optional Required OAuth Scopes data:write Data Format JSON
...
```
curl -v 'https://developer.api.autodesk.com/construction/sheets/v1/projects/9ba6681e-1952-4d54-aac4-9de6d9858dd4/version-sets/7c2ecde0-2406-49f9-9199-50176848a0b7' \ -X 'PATCH' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a' \ -H 'Content-Type: application/json' \ -d '{ "name": "one set", "issuanceDate": "2021-07-01" }'
```
