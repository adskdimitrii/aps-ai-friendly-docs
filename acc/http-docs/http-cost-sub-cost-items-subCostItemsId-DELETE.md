...
| subCostItemsId   string: UUID | The ID of the sub cost item to be deleted. Note that only one sub cost item can be deleted per request. To find the sub cost item ID, call [GET sub-cost-items](/en/docs/bim360/v1/reference/http/cost-sub-cost-items-GET/). |
