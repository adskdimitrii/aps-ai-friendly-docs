...
| Method and URI | PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/segments/:segmentId/values/:valueId |
| --- | --- |
...
| valueId   string: UUID | The segment value ID. To obtain a segment value ID, use [GET segments/:segmentId/values](/en/docs/bim360/v1/reference/http/cost-values-GET/). |
