...
Method and URI GET https://developer.api.autodesk.com/construction/assets/v1/error-codes/{errorCodeName} Authentication Context No security required Required OAuth Scopes No scopes required Data Format JSON
...
```
{ "name" : "FIELD_EXCEEDS_MAX_LENGTH" , "description" : "A string field exceeds the max allowed length." , "httpStatusCode" : 400 , "metadataKeys" : [ "fieldName" , "maxStringLength" ] }
```
