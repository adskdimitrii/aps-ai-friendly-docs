...
| Method and URI | DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/performance-tracking-items/:id |
| --- | --- |
...
| --- | --- |
| id   array: string: uuid | The ID of the budget on which the tracking item to be deleted is based. To find the budget IDs, call [GET performance-tracking-items](/en/docs/bim360/v1/reference/http/cost-performance-tracking-items-GET) and inspect `results.budgetId` in the response. |
