...
- idstring: UUID The object ID of the main contract. You can obtain this ID from the response to the [POST mainContract](/en/docs/bim360/v1/reference/http/cost-main-contracts-POST/) or [GET mainContract](/en/docs/bim360/v1/reference/http/cost-main-contracts-GET/) endpoint.
