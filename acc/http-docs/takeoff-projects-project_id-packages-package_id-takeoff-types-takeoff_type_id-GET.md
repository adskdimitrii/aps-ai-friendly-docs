...
You need to create the type in the UI. For more information, see the [ACC Takeoff Types](https://help.autodesk.com/view/TAKEOFF/ENU/?guid=Takeoff_Types) help documentation.
...
| takeoffTypeId   string: UUID | The takeoff type ID. <br>To find the ID, call [GET takeoff-types](/en/docs/acc/v1/reference/http/takeoff-projects-project_id-packages-package_id-takeoff-types-GET/). |
