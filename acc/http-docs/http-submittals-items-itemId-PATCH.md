...
To check which fields can be updated, call [GET item/:id](http-submittals-items-itemId-GET.md) and review the object with `id: "Item::partial_update"` in the `permittedActions` array in the response.
