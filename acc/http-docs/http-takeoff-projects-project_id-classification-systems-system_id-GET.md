...
To find the hierarchy of a specific classification system, call [GET classifications](/en/docs/acc/v1/reference/http/takeoff-projects-project_id-classification-systems-system_id-classifications-GET/).
