...
Method and URI PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/expenses/:expenseId/items/:id Authentication Context user context required Required OAuth Scopes data:write Data Format JSON
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/expenses/f6445638-ca68-4e3c-9160-15864de6b818/items/f6445638-ca68-4e3c-9160-15864de6b818' \ -X 'PATCH' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a' \ -H 'Content-Type: application/json' \ -d '{ "name": "Site Management Staff", "number": "0001", "budgetId": "48934441-e392-49d7-bf58-8dea43d413ae", "contractId": "f4e86537-9b28-4192-9498-39a5e5931e2f", "description": "Site Management Staff", "note": "Site Management Staff", "scope": "full", "quantity": "The quantity of the expense item. For example 1.", "unitPrice": "1000.0000", "unit": "ls", "amount": "1000.0000", "lockedField": "amount", "aggregateBy": "workCompleted", "exchangeRate": "1.0000", "externalId": "10010-99-AB", "externalSystem": "Sage300", "externalMessage": "Success.", "lastSyncTime": "2019-09-05T01:00:12.989Z", "integrationState": "locked" }'
```
