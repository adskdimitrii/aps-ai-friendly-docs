...
| Method and URI | GET https://developer.api.autodesk.com/hq/v1/accounts/:account_id/users |
| --- | --- |
| Method and URI (Legacy) | GET https://developer.api.autodesk.com/hq/v1/regions/eu/accounts/:account_id/users |
...
| id   string: UUID | BIM 360 user ID |
| --- | --- |
...
Successful Listing of Users in an Account/Hub (200)
