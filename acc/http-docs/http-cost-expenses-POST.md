...
| supplierName   string,null | The supplier company name for the expense. Any company can be used regardless the ones added in Account Administration. Required if `supplierId` is not set. <br>Max length: 255 |
