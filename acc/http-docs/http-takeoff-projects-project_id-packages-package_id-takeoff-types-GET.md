...
You need to create the types in the UI. For more information, see the [Forma Takeoff Types](https://help.autodesk.com/view/TAKEOFF/ENU/?guid=Takeoff_Types) help documentation.
