...
Source: https://aps.autodesk.com/en/docs/acc/reference/http/data-connector-requests-requestId-GET/
...
Method and URI GET https://developer.api.autodesk.com/data-connector/v1/accounts/:accountId/requests/:requestId Authentication Context user context required Required OAuth Scopes data:read Data Format JSON
...
```
curl -v 'https://developer.api.autodesk.com/data-connector/v1/accounts/:accountId/requests/:requestId' \ -H 'Authorization: Bearer AuIPTf4KYLTYGVnOHQ0cuolwCW2a'
```
