...
Retrieves the number of submittals for the submittal groups in each submittal section. To retrieve all submittal data from the Smart Register, call [GET smartregister](/en/docs/acc/v1/reference/http/autospecs-getversionsmartregister-GET/).
