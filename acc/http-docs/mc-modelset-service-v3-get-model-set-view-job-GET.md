# containers/:containerId/modelsets/:modelSetId/views/:viewId/jobs/:jobId

Source: https://aps.autodesk.com/en/docs/acc/reference/http/mc-modelset-service-v3-get-model-set-view-job-GET/
...
Method and URI GET https://developer.api.autodesk.com/bim360/modelset/v3/containers/:containerId/modelsets/:modelSetId/views/:viewId/jobs/:jobId Authentication Context user context required Required OAuth Scopes data:read Data Format JSON
...
containerId string: UUID The GUID that uniquely identifies the container. modelSetId string: UUID The GUID that uniquely identifies the model set. viewId string: UUID The GUID that uniquely identifies the view. jobId string: UUID The GUID that uniquely identifies the job.
...
```
curl -v 'https://developer.api.autodesk.com/bim360/modelset/v3/containers/f0f4f36a-ac64-687f-b132-8efe04b22454/modelsets/00fb28a5-e8a4-2755-562a-7c2f0fc87911/views/7ed27144-ac06-4b72-5dd6-76bee05854be/jobs/49244371-ee08-9afa-01f8-26fcd8ecb03d' \ -H 'Authorization: Bearer <token>'
```
