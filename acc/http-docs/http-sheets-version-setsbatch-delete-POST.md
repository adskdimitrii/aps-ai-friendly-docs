...
| ids*   array: string | The IDs of the version set to delete. To find the version set IDs, call [GET version-sets](http-sheets-version-sets-GET.md). <br>The max number of items is 10. |
| --- | --- |
